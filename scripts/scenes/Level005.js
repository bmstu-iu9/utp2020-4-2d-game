...
export default class Level005 extends CORE.Scene {
	onInitialize() {
	...
	onStart() {
		...
		this.hero = new CORE.GameObject({
			...
			components: [
				...
				new MECH.Controller(),
				new MECH.Collector(),
				new MECH.Player(5, new CORE.Vector2d(-3.5, 0)),
			],
		});
		this.addObject(new CORE.GameObject({
			name: 'sounds',
		...
		this.addObject(new CORE.GameObject({
			...
			position: new CORE.Vector2d(61, 0.4),
			isStatic: true,
			components: [
		...
		this.addObject(new CORE.GameObject({
			name: 'platform',
			scale: new CORE.Vector2d(1, 1),
			position: new CORE.Vector2d(62, 0.4),
			isStatic: true,
			components: [
				new CORE.TileMap(16, 16, ss, [
                    ...
                    [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '01', '01', '01', '01'],
					[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,  null, null, null, null, '01', '01', '01', '01', '01', '01', '01', '01'],
		...
		this.addObject(new CORE.GameObject({
			name: 'ladders',
			scale: new CORE.Vector2d(1, 2),
			position: new CORE.Vector2d(36, 1.2),
			components: [
        ...
        this.addObject(new CORE.GameObject({
			name: 'ladders',
			scale: new CORE.Vector2d(1, 2),
			position: new CORE.Vector2d(88, 1.2),
			components: [
				new CORE.BoxCollider(0.1, 4),
			],
			children: [
				new CORE.GameObject({
					name: 'ladder-sprite',
					position: new CORE.Vector2d(0, 1),
					components: [
						new CORE.TileMap(16, 16, ss, [
							['ladders'],
							['ladders'],
        ...
        this.createRailSpike(1.6, new CORE.Vector2d(112, 2.2), 3);
        this.createTurrel(new CORE.Vector2d(114, -0.6), Math.PI / 2, 4, 2);
		...
		this.addObject(new CORE.GameObject({
			...
			components: [
				...
				new MECH.Door(Level01, this.hero),
