...
import HardLevel3 from './HardLevel3.js';

export default class HardLevel2 extends GameScene {
	onStart() {
		const ss = CORE.Game.resources.getTiles('tileset');
		this.hero = this.createHero(new CORE.Vector2d(-93, -0.5), 3);
		this.createSounds();
		...
		this.createRailSpike(5, new CORE.Vector2d(-89, -3.2), 4);
		this.createRailSpike(5, new CORE.Vector2d(-81, -3.2), 4);
		this.createRailSpike(5, new CORE.Vector2d(-74.5, -3.2), 4);
		this.createCoin(new CORE.Vector2d(-60, 2));
		this.createLadder(new CORE.Vector2d(-44, -0.1), 9);
		this.createRailSpike(4.5, new CORE.Vector2d(-31, -3.2), 4);
		this.createCoin(new CORE.Vector2d(-29, -3));
		this.createRailSpike(4, new CORE.Vector2d(-26.5, -3.2), 5);
		this.createExtraLife(new CORE.Vector2d(0, -2.5));
		this.createCheckPoint(new CORE.Vector2d(4, -2.75));
		this.createRailSpike(5, new CORE.Vector2d(11, -3.2), 5);
		this.createRailSpike(5, new CORE.Vector2d(11, 0.1), 5, Math.PI);
		this.createCoin(new CORE.Vector2d(14, -3));
		this.createRailSpike(4, new CORE.Vector2d(14.2, -1.5), 4, 3 * Math.PI / 2);
		this.createLadder(new CORE.Vector2d(16, -0.1), 9);
		this.createRailSpike(5, new CORE.Vector2d(29, -3.2), 5);
		this.createCoin(new CORE.Vector2d(31, -3));
		this.createRailSpike(7, new CORE.Vector2d(31, -3.2), 10);
		this.createRailSpike(5, new CORE.Vector2d(33, -3.2), 7);
		this.createLadder(new CORE.Vector2d(53, -0.1), 9);
		this.createTurrel(new CORE.Vector2d(62, 1.5), Math.PI / 2, 7, 1.5);
		this.createTurrel(new CORE.Vector2d(66, 1.5), Math.PI / 2, 7, 1.5);
		this.createTurrel(new CORE.Vector2d(70, 1.5), Math.PI / 2, 7, 1.5);
		this.createTurrel(new CORE.Vector2d(74, 1.5), Math.PI / 2, 7, 1.5);
		this.createTurrel(new CORE.Vector2d(78, 1.5), Math.PI / 2, 7, 1.5);
		this.createTurrel(new CORE.Vector2d(82, 1.5), Math.PI / 2, 7, 1.5);
		this.createCoin(new CORE.Vector2d(87, 6));
		this.createDoor(new CORE.Vector2d(89, 6.5), HardLevel3, this.hero);
		this.createCamera(this.hero, -0.5);
		this.createUI(this.hero, -5);
	}
}
