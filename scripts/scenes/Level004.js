...
import Level005 from './Level005.js';

export default class Level004 extends CORE.Scene {
	onInitialize() {
	...
	onStart() {
		...
		this.addObject(new CORE.GameObject({
			...
			position: new CORE.Vector2d(39, 3),
			isStatic: true,
			components: [
		...
		this.createRailSpike(2.2, new CORE.Vector2d(0, 1.8), 5);
        this.createRailSpike(2.7, new CORE.Vector2d(0, 4.2), 5, Math.PI);
        this.createRailSpike(2.2, new CORE.Vector2d(6, 1.8), 7);
        this.createRailSpike(2.7, new CORE.Vector2d(6, 4.2), 7, Math.PI);
        this.createRailSpike(2.2, new CORE.Vector2d(11.5, 1.8), 4);
        this.createRailSpike(2.2, new CORE.Vector2d(13, 4.2), 7, Math.PI);
        this.createRailSpike(2.2, new CORE.Vector2d(16.5, 1.8), 6);
        this.createRailSpike(2.9, new CORE.Vector2d(19, 4.2), 5, Math.PI);
        this.createRailSpike(3, new CORE.Vector2d(23.5, 1.8), 8);
        this.createRailSpike(1.5, new CORE.Vector2d(23, 4.2), 3, Math.PI);
        this.createRailSpike(2.4, new CORE.Vector2d(30, 1.8), 5);
        this.createRailSpike(2, new CORE.Vector2d(26.5, 4.2), 4, Math.PI);
        this.createRailSpike(2.5, new CORE.Vector2d(35.5, 1.8), 6);
        this.createRailSpike(1.8, new CORE.Vector2d(31, 4.2), 5, Math.PI);
        this.createRailSpike(2, new CORE.Vector2d(40.5, 1.8), 4);
        this.createRailSpike(3.5, new CORE.Vector2d(38, 4.2), 9, Math.PI);
        this.createRailSpike(3.2, new CORE.Vector2d(46, 1.8), 7);
        this.createRailSpike(3, new CORE.Vector2d(45.5, 4.2), 6, Math.PI);
        this.createRailSpike(2, new CORE.Vector2d(51.5, 1.8), 4);
        this.createRailSpike(4, new CORE.Vector2d(52.5, 4.2), 8, Math.PI);
        this.createRailSpike(2, new CORE.Vector2d(56, 1.8), 5);
        this.createRailSpike(2.8, new CORE.Vector2d(59, 4.2), 5, Math.PI);
        this.createRailSpike(2.5, new CORE.Vector2d(61.5, 1.8), 6);
        this.createRailSpike(2, new CORE.Vector2d(63, 4.2), 3, Math.PI);
        this.createCoin(new CORE.Vector2d(71, 2.5));
        this.createCoin(new CORE.Vector2d(73, 2.5));
        this.createCoin(new CORE.Vector2d(75, 2.5));
        this.createCoin(new CORE.Vector2d(77, 2.5));
		this.createCoin(new CORE.Vector2d(79, 2.5));
		this.addObject(new CORE.GameObject({
			name: 'door',
			position: new CORE.Vector2d(82, 3),
			scale: new CORE.Vector2d(0.5, 0.5),
			components: [
				new CORE.SpriteRenderer(new CORE.Sprite(this.resources.getImage('extraLife'))),
				new MECH.Door(Level005, this.hero),
