...
import Level004 from './Level004.js';

export default class Level003 extends CORE.Scene {
	onInitialize() {
	...
	onStart() {
		...
		this.hero = new CORE.GameObject({
			...
			position: new CORE.Vector2d(-3.5, 8),
			components: [
				...
				new MECH.Controller(),
				new MECH.Collector(),
				new MECH.Player(5, new CORE.Vector2d(-3.5, 8)),
			],
		});
		this.addObject(new CORE.GameObject({
			name: 'sounds',
		...
		this.addObject(new CORE.GameObject({
			...
			position: new CORE.Vector2d(94, 2.6),
			isStatic: true,
			components: [
        ...
        this.addObject(new CORE.GameObject({
			name: 'ladders',
			scale: new CORE.Vector2d(1, 1),
			position: new CORE.Vector2d(35, 3.5),
			components: [
				new CORE.BoxCollider(0.1, 7),
			],
			children: [
				new CORE.GameObject({
					name: 'ladder-sprite',
		...
		this.addObject(new CORE.GameObject({
			name: 'ladders',
			scale: new CORE.Vector2d(1, 1),
			position: new CORE.Vector2d(90, 3.5),
			components: [
				new CORE.BoxCollider(0.1, 9),
			],
			children: [
				new CORE.GameObject({
					name: 'ladder-sprite',
		...
		this.addObject(new CORE.GameObject({
			name: 'ladders',
			scale: new CORE.Vector2d(1, 1),
			position: new CORE.Vector2d(140, 3.5),
			components: [
				new CORE.BoxCollider(0.1, 7),
			],
			children: [
		...
		this.createRailSpike(3, new CORE.Vector2d(0, 7.4), 5);
		this.createRailSpike(3, new CORE.Vector2d(6, 7.4), 4);
		this.createRailSpike(3, new CORE.Vector2d(14, 7.4), 5);
		this.createCheckPoint(new CORE.Vector2d(31, 7.7));
        this.createTurrel(new CORE.Vector2d(46.5, -1.4), Math.PI / 2, 3.5, 2);
        this.createTurrel(new CORE.Vector2d(51.5, -1.4), Math.PI / 2, 3.5, 2);
        this.createTurrel(new CORE.Vector2d(56.5, -1.4), Math.PI / 2, 3.5, 2);
        this.createTurrel(new CORE.Vector2d(61.5, -1.4), Math.PI / 2, 3.5, 2);
        this.createTurrel(new CORE.Vector2d(66.5, -1.4), Math.PI / 2, 3.5, 2);
        this.createTurrel(new CORE.Vector2d(71.5, -1.4), Math.PI / 2, 3.5, 2);
        this.createTurrel(new CORE.Vector2d(76.5, -1.4), Math.PI / 2, 3.5, 2);
		this.createCoin(new CORE.Vector2d(17, 7.5));
		this.createExtraLife(new CORE.Vector2d(93.5, -1));
		this.createRailSpike(4, new CORE.Vector2d(17, 7.4), 7);
		this.createRailSpike(2.7, new CORE.Vector2d(20, 7.4), 5);
		this.createCoin(new CORE.Vector2d(60, 3.5));
		this.createRailSpike(3, new CORE.Vector2d(96, -1.6), 4);
		this.createRailSpike(2.7, new CORE.Vector2d(100.5, -1.6), 5);
		this.createCoin(new CORE.Vector2d(99, -1.6));
        this.createRailSpike(3.2, new CORE.Vector2d(105, -1.6), 4);
        this.createTurrel(new CORE.Vector2d(111.9, -0.4), 0, 3, 4);
        this.createCoin(new CORE.Vector2d(120, 4.5));
        this.createCheckPoint(new CORE.Vector2d(122, 4.6));
		this.createTurrel(new CORE.Vector2d(146.5, -2.4), Math.PI / 2, 4, 3);
		this.createExtraLife(new CORE.Vector2d(149, 2.5));
		this.createRailSpike(2.5, new CORE.Vector2d(149.5, 1.4), 4);
        this.createRailSpike(3, new CORE.Vector2d(155.5, 1.4), 4);
        this.createTurrel(new CORE.Vector2d(152.5, -2.4), Math.PI / 2, 5, 3);
        this.createRailSpike(2.8, new CORE.Vector2d(161.5, 1.4), 4);
        this.createTurrel(new CORE.Vector2d(158.5, -2.4), Math.PI / 2, 5, 3);
        this.createRailSpike(3.2, new CORE.Vector2d(167.5, 1.4), 4);
        this.createTurrel(new CORE.Vector2d(164.5, -2.4), Math.PI / 2, 5, 3);
        this.createRailSpike(3, new CORE.Vector2d(173.5, 1.4), 4);
        this.createTurrel(new CORE.Vector2d(170.5, -2.4), Math.PI / 2, 5, 3);
		this.createCoin(new CORE.Vector2d(185, 1.4));
		this.addObject(new CORE.GameObject({
			name: 'door',
			position: new CORE.Vector2d(188, 2.1),
			scale: new CORE.Vector2d(0.5, 0.5),
			components: [
				new CORE.SpriteRenderer(new CORE.Sprite(this.resources.getImage('extraLife'))),
				new MECH.Door(Level004, this.hero),
